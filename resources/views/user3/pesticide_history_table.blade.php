<div class="card pesticide_history">
    ...
    <div class="card-body">
        <form action="{{url('user3/pesticides_history_data')}}">
            <div class="row text-center">
                    ...
                    <div class="col flex">
                        <div class="box">
                            ...
                            <div class="form-group">
                                ...
                                <select id="pesticide_history_drop_down" name="select" class="form-control">
                ...
                <table id="pesticides_history_table"></table>
            </div>
        </form>
    </div>
</div>